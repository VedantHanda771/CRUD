...
exports.USAGE = `
  ...
  ${(0, clr_1.colorizeForStderr)(i18n_1.default.__('cli-repl.args.oidcOptions'), 'mongosh:section-header')}

        --oidcFlows[=auth-code,device-auth]    ${i18n_1.default.__('cli-repl.args.oidcFlows')}
        --oidcRedirectUri[=url]                ${i18n_1.default.__('cli-repl.args.oidcRedirectUri')}
        --oidcTrustedEndpoint                  ${i18n_1.default.__('cli-repl.args.oidcTrustedEndpoint')}
        --oidcIdTokenAsAccessToken             ${i18n_1.default.__('cli-repl.args.oidcIdTokenAsAccessToken')}
        --oidcDumpTokens[=mode]                ${i18n_1.default.__('cli-repl.args.oidcDumpTokens')}
